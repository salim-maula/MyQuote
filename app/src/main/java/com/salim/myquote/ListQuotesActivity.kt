...
import com.salim.myquote.databinding.ActivityListQuotesBinding
        ...
        client.get(url, object : AsyncHttpResponseHandler(){
            override fun onSuccess(
                ...
                try {
                    ...
                    val adapter = ArrayAdapter(this@ListQuotesActivity, android.R.layout.simple_expandable_list_item_1,listQuote)
